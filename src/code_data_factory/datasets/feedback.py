...
def build_data_actions(*, evaluation_path: Path, findings_path: Path, candidate_pool_path: Path, output_dir: Path, policy_path: Path) -> dict[str, object]:
    ...
    receipt = {"kind": "development-feedback-actions", "evaluation_split": "DEVELOPMENT", "candidate_pool_version": next(iter(versions)), "actions": actions, "final_test_ingress_count": 0}
