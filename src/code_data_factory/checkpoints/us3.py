...
def run_us3_checkpoint(*, output_path: Path, suite_manifest: Path, evaluation_path: Path, findings_path: Path, actions_path: Path, recipes_path: Path) -> dict[str, object]:
